...
namespace DrumTrainer.UI.Mono
{
    ...
    public partial class UserControl1 : SkiaSharp.Views.Desktop.SKControl
    {
        ...
        private void Instance_Log(Drumz.Common.Diagnostics.Logger.Level level, string message)
        {
            Log?.Invoke(message);
        }
        ...
        private readonly Drumz.Common.Utils.FpsCounter fpsCounter = new Drumz.Common.Utils.FpsCounter(50);
